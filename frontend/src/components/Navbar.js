              ...
              {showContactDropdown && (
                <>
                  ...
                  <div className="absolute right-0 top-full mt-2 bg-white shadow-2xl border border-gray-200 rounded-lg p-4 w-64 z-50" data-testid="navbar-contact-dropdown">
                    ...
                    <a href="tel:+919973634393" className="flex items-center gap-3 p-2 hover:bg-red-50 rounded-lg transition-colors group" data-testid="navbar-phone-link">
                    ...
                    <a href="https://wa.me/919973634393?text=Hi%2C%20I%20want%20to%20book%20a%20newspaper%20ad" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-2 hover:bg-green-50 rounded-lg transition-colors group mt-1" data-testid="navbar-whatsapp-link">
